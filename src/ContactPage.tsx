  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('nav_contact')}</h1>
        <p className="text-lg text-gray-600">
          {i18n.language === 'ms' ? 'Ada soalan atau maklum balas? Kami sedia membantu anda.' : 'Have questions or feedback? We are here to help.'}
        </p>
      </div>
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-900">{t('contact_location')}</h3>
          ...
          <div className="bg-blue-600 p-6 rounded-2xl text-white shadow-lg shadow-blue-100">
            <h3 className="font-bold text-lg mb-2">{t('contact_hours')}</h3>
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-8">
                  {i18n.language === 'ms' ? 'Terima kasih kerana menghubungi kami. Kami akan membalas mesej anda secepat mungkin.' : 'Thank you for contacting us. We will get back to you soon.'}
                </p>
                <button 
                  onClick={() => setSubmitted(false)}
                  className="px-6 py-2 bg-blue-600 text-white rounded-full font-bold hover:bg-blue-700 transition-all"
                >
                  {i18n.language === 'ms' ? 'Hantar Mesej Lain' : 'Send Another Message'}
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-sm font-bold text-gray-700">{t('contact_name')}</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-bold text-gray-700">{t('contact_email')}</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-bold text-gray-700">{t('contact_subject')}</label>
                  <input
                    type="text"
                    id="subject"
                    name="subject"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-bold text-gray-700">{t('contact_message')}</label>
                  <textarea
                    id="message"
                    name="message"
                    required
